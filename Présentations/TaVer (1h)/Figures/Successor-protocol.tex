\begin{tikzpicture}[xscale=0.5,node distance=3cm,auto, AUT style,>= triangle
	45]
	...
	\path[->, bend right=10] (0) edge node[below left] {$\mathbf{rec}(a, \downarrow \reg_1)$} (x');
