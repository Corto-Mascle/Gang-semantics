\begin{tikzpicture}
	...
	\node (4) at (5.4,0.2) {\scriptsize $\br(\color{orange}m\color{black}, v_0)$};
	}
	...
	{
		\draw[->] (-2,-3) -- (3.2,-3);
		\node (0') at (-0.4,-2.8) {\scriptsize $\br(\color{purple}m_1, v_1\color{black})$};
		\node (1') at (-1.6,-3.2) {\scriptsize $\rec(m_0, v_0)$};
		\node (2') at (1,-3.2) {\scriptsize $\rec(m_2, v_2)$};
		\node (3') at (2.2,-2.8) {\scriptsize $\br(\color{purple}m_3, v_1\color{black})$};
	}
...
%	\draw[purple, arrows = {-Stealth[length=5pt, inset=2pt]}] (3.6, -1.7) .. controls +(0,1) and +(0,-1) .. (5.5, -0.4);
	...
	\onslide<5->
	{
		...
		\node (2'') at (6,-3.2) {\scriptsize $\rec(\color{gray}m_1, v_1\color{black})$};
