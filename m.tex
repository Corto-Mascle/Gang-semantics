...
\begin{document}
	...
	\begin{abstract}
		We consider the parameterized verification of a model representing an arbitrarily large network of agents which communicate by broadcasting and receiving mess ages. The boradcast topology is reconfigurable, hence a message sent may be received by any set of agents.
