...
For "follower specifications", it goes in the opposite direction: for a fixed $\followmessagespec$, the shorter the requirement $\followwordspec$, the better. Therefore, we have the following two ways of shortening an "unfolding tree":
