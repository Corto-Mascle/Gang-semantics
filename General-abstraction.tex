...
\begin{restatable}{proposition}{PropBoundTreeSize}
	...
	There exists a function $f$ of the class $\Ffunction{\omega^{\size{\messages}+1}}$ such that for every positive instance $(\prot,q_f)$ of \COVER, there exists a "coverability witness" $\tree$ of size bounded by $f(\size{\prot})$.
\end{restatable}
