...
\multidef{\text{\sc{#1}}\xspace}{co,coNP,NP,PSPACE,coPSPACE,NPSPACE,PTIME,EXPTIME,EXPSPACE,NEXPTIME, LOGSPACE, TOWER, COVER, TARGET, BNRA}
\newcommand{\Falpha}[1]{\mathcal{F}_{#1}}
...
\newcommand{\recone}[2]{\textbf{r}(#1, #2)}
...
\newcommand{\inttest}{\xrightarrow{\locsymb}}
\newcommand{\intmessage}[2]{\xrightarrow{\brsymb, #1, #2}}
\newcommand{\extmessage}[2]{\xrightarrow{\recsymb, #1, #2}}
