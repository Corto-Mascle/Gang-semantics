...
\begin{tikzpicture} [xscale = 1, yscale = 0.6, every node/.style = {scale = 0.9}]
	...
	% \regbar{-3.5}{-3}
	\onerow{-2}{-3.5}{$q_0$}{$2$}{orange}{$\_$}{white}{$\_$}{white}
	\transtable{-1}{-3.5}{$\extlabel{\atrans_{05}}{4}$}
	\onerow{-1}{-3.5}{$q_5$}{$2$}{orange}{$\_$}{white}{$\_$}{white}
	\transtable{0}{-3.5}{\color{ForestGreen} $\intlabel{\atrans_{55}}$}
	\onerow{-0}{-3.5}{$q_5$}{$2$}{orange}{$\_$}{white}{$\_$}{white}
	\transtable{1}{-3.5}{\color{Rhodamine} $\intlabel{\atrans_{56}}$}
	\onerow{1}{-3.5}{$q_6$}{$2$}{orange}{$\_$}{white}{$\_$}{white}
	\node [align=center, font = {\footnotesize}] (sp) at (-3.3, -3-0.8) {Node $\node_2$ ($a_2$)};
	\node [align = center, font = {\footnotesize}] (sp) at (-3.3,-3.5-0.8) {$\spec = {\color{ForestGreen} \exready} \cdot {\color{Rhodamine} \exgotwo}$};
	\node [align = center, font = {\footnotesize}] (sp) at (-3.3, -4-0.8) {$v = 2$};
	\end{scope}
	\begin{scope}[xshift = 5]
	% \regbar{3}{-3}
	\onerow{2}{-3.5}{$q_0$}{$3$}{cyan}{$\_$}{white}{$\_$}{white}
	\transtable{3}{-3.5}{\color{ForestGreen}$\intlabel{\atrans_{00}}$}
	\onerow{3}{-3.5}{$q_0$}{$3$}{cyan}{$\_$}{white}{$\_$}{white}
	\transtable{4}{-3.5}{$\extlabel{\atrans_{05}}{5}$}
	\onerow{4}{-3.5}{$q_5$}{$3$}{cyan}{$\_$}{white}{$\_$}{white}
	\transtable{5}{-3.5}{\color{BlueViolet}$\intlabel{\atrans_{57}}$}
	\onerow{5}{-3.5}{$q_7$}{$3$}{cyan}{$\_$}{white}{$\_$}{white}
	\node [align=center, font = {\footnotesize}] (sp) at (7.2, -3-0.8) {Node $\node_3$ ($a_3$)};
	\node [align = center, font = {\footnotesize}] (sp) at (7.2,-3.5-0.8) {$\spec = { \color{ForestGreen}\exready} \cdot {\color{BlueViolet} \exgothree}$};
...
\begin{scope}[xscale = 1.2, xshift = 0]
	...
	\transtable{0}{-7}{\color{ForestGreen}$\intlabel{\atrans_{00}}{}$}
	\onerow{-0}{-7}{$q_0$}{$4$}{white}{$\_$}{white}{$\_$}{white}
	\node [align=center, font = {\footnotesize}] (sp) at (-2, -3.5-0.8-3) {Node $\node_4$ ($a_3$)};
	\node [align = center, font = {\footnotesize}] (sp) at (-2,-4-0.8-3) {$\spec = {\color{ForestGreen} \exready}$};
