...
\begin{tikzpicture}
	...
	\node [] (sp) at (6, 0.2-0.5) {Node $\node_1$};
	\node [] (sp) at (6, 0.2-1) {$\spec(\node_1) = \epsilon$};
	\node [] (sp) at (6, 0.2-1.5) {$v = 1$};
	...
	\onerow{0}{-3}{$q_5$}{$2$}{orange}{$\_$}{white}{$\_$}{white}
	\node [align=center] (sp) at (-5.5, -2.5-0.8) {Node $\node_2$};
	\node [align = center] (sp) at (-5.5,-3-0.8) {$\spec = \exready \cdot \exgo$};
	\node [align = center] (sp) at (-5.5, -3.5-0.8) {$v = 2$};

	\regbar{3}{-3}
	\onerow{3.5}{-3}{$q_0$}{$3$}{cyan}{$\_$}{white}{$\_$}{white}
	\onerow{4.5}{-3}{$q_5$}{$3$}{cyan}{$\_$}{white}{$\_$}{white}
	\onerow{5.5}{-3}{$q_5$}{$3$}{cyan}{$\_$}{white}{$\_$}{white}
	\node [align=center] (sp) at (8, -2.5-0.8) {Node $\node_3$};
	\node [align = center] (sp) at (8,-3-0.8) {$\spec = \exready \cdot \exgo$};
	\node [align = center] (sp) at (8, -3.5-0.8) {$v = 3$};
...
\draw (5, -3-1.7) -- (5, -3-1.7-0.7);
	...
	\node [align=center] (sp) at (-4.5, -2.5-0.8-3) {Node $\node_4$};
	\node [align = center] (sp) at (-4.5,-3-0.8-3) {$\spec = \exready$};
	\node [align = center] (sp) at (-4.5, -3.5-0.8-3) {$v = 4$};
	
	\regbar{3.5}{-6}
	\onerow{4}{-6}{$q_0$}{$5$}{white}{$\_$}{white}{$\_$}{white}
	\onerow{5}{-6}{$q_5$}{$5$}{white}{$\_$}{white}{$\_$}{white}
	\node [align=center] (sp) at (7, -2.5-0.8-3) {Node $\node_5$};
	\node [align = center] (sp) at (7,-3-0.8-3) {$\spec = \exready$};
	\node [align = center] (sp) at (7, -3.5-0.8-3) {$v = 5$};

\draw (5, -6-1.7) -- (5, -6-1.7-0.7);

	\regbar{3.5}{-9}
	\onerow{4}{-9}{$q_0$}{$6$}{white}{$\_$}{white}{$\_$}{white}
	\onerow{5}{-9}{$q_5$}{$6$}{white}{$\_$}{white}{$\_$}{white}
	\node [align=center] (sp) at (7, -8.5-0.8) {Node $\node_7$};
	\node [align = center] (sp) at (7,-9-0.8) {$\spec = \exready$};
	\node [align = center] (sp) at (7, -9.5-0.8) {$v = 7$};
