...
\newcommand{\displayone}[1]{{\color{green!80!black} #1}}
\newcommand{\displaytwo}[1]{{\color{cyan} #1}}
\newcommand{\displaythree}[1]{{\color{OrangeRed} #1}}
\begin{tikzpicture} [xscale = 1, yscale = 0.6, every node/.style = {scale = 0.9}]
	...
	\transtable{-1}{-3.5}{$\displayone{\extlabel{\atrans_{05}}{4}}$}
	\onerow{-1}{-3.5}{$q_5$}{$2$}{white}{$\_$}{white}{$\_$}{white}
	\transtable{0}{-3.5}{$\displayone{\intlabel{\atrans_{55}}}$}
