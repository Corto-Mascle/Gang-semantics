...
%
	...
	\input{Intro}
		\paragraph*{}
	In this document, occurrences of notions is linked to the definitions of the notions using the \href{https://www.irif.fr/~colcombe/knowledge_en.html}{knowledge package}. On electronic devices, clicking on words or symbols allows to access their definitions.
