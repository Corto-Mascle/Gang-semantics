...
\begin{proof}[Proof sketch]
	...
	A node of maximal "altitude"  has at most one message to broadcast (to its potential parent), and so by \cref{lem:short-local-runs}, we get that its size is bounded by $\towerfun(\size{\prot},r)$.
