...
\nico{abus de notation du $O()$ avec plusieurs paramètres, ça vous choque?}
\todo{go to appendix and adapt to new, simplified statement}
	% \begin{enumerate}				
...
\decidablecover*
\nico{on ne veut pas essayer d'avoir la classe exacte à taille d'alphabet fixé?}
