\begin{tikzpicture}[xscale=0.9]
	...
	\draw[->] (5.5,-1.8) -- (7.5,-1.8);
	\draw[->] (9.5,-1.8) -- (12.5,-1.8);
	
	\node (0) at (-1,-1.8) {$\localrunlabel{\node}$};
 	\node (1) at (5,-1.8) {$\run_1$};
 	\node (2) at (9,-1.8) {$\run_2$};
	...
	\node (b) at (6,-2.1) {$\recsymb({\color{blue}a\color{black}})$};
	\node (b) at (7,-1.6) {$\brone{\color{blue}b\color{black}}$};
	
	\node (b) at (10,-2.1) {$\recsymb({\color{blue}a\color{black}})$};
	\node (b) at (11,-2.1) {$\recsymb({\color{blue}b\color{black}})$};
	\node (b) at (12,-1.6) {$\brone{\color{blue}c\color{black}}$};

	\node (1) at (1.5,-2.6) {$\bosslabel{\node}=aac$};
	\node (1) at (6.5,-2.6) {$\run_1 \text{ satisfies } (a,b)$};
	\node (1) at (11,-2.6) {$\run_2 \text{ satisfies } (ab,c)$};

	\node (1) at (1.5,-3) {$\decsymb = (a,b, a, c, \epsilon)$};
	\node (1) at (6.5,-3) {$\decsymb_1 = (a)$};
	\node (1) at (11,-3) {$\decsymb_2 = (a, b, a)$};
...
%	\node (r') at (9.5, -7) {$\run''$};
	\node[text width = 4cm] (txt1) at (10, -6.5) {We compose $\run'$ with $\run_2$ to match an "unmatched reception" $b$};
...
%	\node (txt2) at (11.7, -9.5) {eliminate the last $b$ input};
	...
	\node (d) at (5,-8.3) {\Huge \vdots};
 	\node[text width=4cm] (d) at (10,-8.5) {... and iterate compositions with $\run_{1}$ and $\run_2$ until the "run" does not have any "unmatched reception".};
%	\node (b1) at (0,0.6) {};
%	\node (b2) at (1,0.6) {};
%	\node (b3) at (3,0.6) {};
%	\node (b4) at (5,0.6) {};
