\begin{tikzpicture}
	...
	\draw (0,0.5) rectangle (5,1);
	
	\node[draw] (f1) at (-0.5,3) {$(ab, a)$};
	\node[draw] (f2) at (1,3) {$(aa, c)$};
	\node[draw] (f3) at (2.8,3) {$(abc, d)$};
	
	\node[draw] (b1) at (0.5,-1) {$ba$};
	\node[draw] (f2) at (2.1,-1) {$cb$};
	\node[draw] (f3) at (3.8,-1) {$a$};
\end{tikzpicture}
...
\begin{tikzpicture}
	...
	\node (H) at (5, 3) {$\altitude{}$};
	
	\node (R) at (0.4,-0.2) {root ($\altitude{} =0$)};
