...
As a result, there is an run in which agent $a$ reaches $m'$.

Now suppose there is an run $\run$ over some set of agents $\agents$ such that some agent $a \in \agents$ is in state $m'$ in the final configuration.
