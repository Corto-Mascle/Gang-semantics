...
\begin{lemma}
	...
	For all $i$, there exists a set of agents $\agents_i$, a configuration $\config_i$, an "initial run" $\run_i : \config_0 \step{*} \config_i$ over $\agents_i$, agents $a_0, \cdots, a_n \in \agents_i$ and values $v_0, \ldots, v_n \in \nats$ such that:
	\begin{itemize}
