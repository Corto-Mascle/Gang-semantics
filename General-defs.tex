...
Bounding "bad" sequences in well quasi-orders leads to very large functions, such as the Ackermann function for vectors of natural numbers. A convenient formalism for those functions is the "Fast-growing hierarchy" defined below.

Let $\alpha$ be an ordinal in Cantor normal form. We define $\Falpha{\alpha}$ as follows:
