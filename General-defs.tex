...
\begin{example}\label{ex:example-1}
	...
	\end{multline*}
	The broadcast messages are, this order: $(m_2,x_1)$ by $a_1$, $(m_4,y_2)$ by $a_2$, $(m_6,x_1)$ by $a_1$ and $(m_7,x_1)$ by $a_1$. Each broadcast message is received by the other agent. 
\end{example}
