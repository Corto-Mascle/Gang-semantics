...
\begin{proof}
	...
	This agent $a_j$ must be in state $\ell_j^{p_j}$ after receiving the broadcast $\br(\ell_j^{p_j})$ \nicoin{je comprends pas tt mais y a un pb ici} from $a$ (as all agents start with different register values).
