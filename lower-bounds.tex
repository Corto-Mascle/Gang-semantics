...
\luin{here should come an example}
...
\paragraph*{NP-hardness.} We present here a reduction of the 3SAT problem to the "query coverability problem" in the 1-register case.\lu{ça vous va comme formulation?}
