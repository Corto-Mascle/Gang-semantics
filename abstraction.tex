...
\nicoin{apply the induction on $\run_k$, then mimick step $s_k$ in the abstract semantics, and finish the abstract run using Lemma~\ref{lem:proof_completeness_covset_constant}}
\end{proof}
