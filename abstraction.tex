...
The \NP lower bound follows from a reduction from 3SAT (an agent $a$ broadcasts a valuation with its identifier to other agents which broadcast it back, allowing $a$ to check the satisfaction of a 3SAT formula).
